...
// // import 'package:blogapp/model/moviedetailmodel.dart';
...
//             movies.value = response.data['results'].map<BlogModel>((movie)=> BlogModel.fromJson(movie)).toList();
//           }else{
//             debugPrint("In page WITH CONDITION : ${allMoviesPage.value}");
//             movies.addAll(response.data['results'].map<BlogModel>((movie)=> BlogModel.fromJson(movie)).toList());
//           }
//           allMoviesPage.value++;
//           update();
//         }
